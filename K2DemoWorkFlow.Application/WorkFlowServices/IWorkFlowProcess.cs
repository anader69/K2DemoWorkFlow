...
namespace K2DemoWorkFlow.Application.WorkFlowServices
{
    public interface IWorkFlowProcess
    {
        ...
        Task<ApiResponseOfK2WorklistItem> TakeActionOnWorkflowAsync(string taskSerialNumber, string actionName, string username, Dictionary<WorkflowDataFields, object> dataFields = null);
