...
namespace Commons.K2
{
    ...
    public class K2Config
    {
        ...
        public static K2Config GetFromConnectionStrings(string clientKey, string managementKey)
        {
            ...
            var clientConnectionString = ConfigurationManager.ConnectionStrings[clientKey].ConnectionString;
            var managementConnectionString = ConfigurationManager.ConnectionStrings[managementKey].ConnectionString;
