...
namespace Framework.Core.Validators
{
    ...
    public abstract class BaseValidator<TModel> : AbstractValidator<TModel> where TModel : class
    {
        ...
        protected virtual void SetDatabaseValidationRules<TEntity>(IBaseDbContext dbContext, params string[] filterStringPropertyNames)
        ...
        protected virtual void SetStringPropertiesMaxLength<TEntity>(IBaseDbContext dbContext, params string[] filterPropertyNames)
            where TEntity : IEntityBase
        {
            if (dbContext == null)
                return;
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <param name="dbContext">Database context</param>
        //protected virtual void SetDecimalMaxValue<TEntity>(IEfCoreDbContext dbContext) where TEntity : IEntity
        //{
        //    if (dbContext == null)
        //        return;
